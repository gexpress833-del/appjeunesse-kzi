...
class VideoEmbed
{
    ...
    public static function toEmbed(?string $url): ?string
    {
        ...
        if (preg_match('~(?:https?:\/\/)?(?:www\.)?(?:youtube\.com\/(?:watch\?v=|live\/|embed\/|shorts\/)|youtu\.be\/|youtube-nocookie\.com\/embed\/)([A-Za-z0-9_-]{11})~i', $url, $m)) {
            return 'https://www.youtube-nocookie.com/embed/'.$m[1].'?controls=0&disablekb=1&enablejsapi=1&fs=0&iv_load_policy=3&modestbranding=1&origin='.urlencode(self::origin()).'&playsinline=1&rel=0';
        }
