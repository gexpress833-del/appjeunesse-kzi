...
<div class="flex flex-wrap items-start justify-between gap-4">
    ...
    <div class="flex flex-wrap items-center gap-2">
        @if (auth()->user()->isAdmin())
            <a href="{{ route('members.pdf', $member) }}" data-no-loading class="rounded-xl border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-semibold text-rose-700 hover:bg-rose-100">Exporter en PDF</a>
        @endif
